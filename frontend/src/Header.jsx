  ...
  render() {
    return (
      <header className="py-5 text-center">
        ...
        <p className="lead">This is a simple application, showcasing the Email-sending facility provided by Common Messaging Service.<br/>It requires a Service Client that has

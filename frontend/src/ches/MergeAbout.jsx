      ...
      <div>
        ...
        <ul>
          ...
          <li>Any other field that contains a date, the Excel parser will translate to YYYY-MM-DD. Look in the
            csv file to see various formats it can translate.
          </li>
          ...
          <li>Also, note down the lefthand side of the body is a listing of the variables you can use in the

...
const {healthCheck, getStatus, cancelMsg, sendEmail, emailMerge, emailPreview} = require('./controller');
...
routes.delete('/cancel/:msgId', wrap(async function (req, res, next) {
  await cancelMsg(req, res, next);
}));
